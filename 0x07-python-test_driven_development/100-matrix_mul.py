...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        TypeError: If m_a or m_b is not a list of lists, or contains elements
        not int/ float, or if m_a & m_b are not matrices.
        ValueError: If m_a or m_b is empty, or if m_a & m_b
    ...
    if not all(isinstance(rOw, list) for rOw in m_a) or \
        ...
        raise TypeError("m_a must be a list \
                of lists or m_b must be a list of lists")
